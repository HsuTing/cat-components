...
export default [
  ...
  '',
  '`Link` is a component of `Link` in `react-router-dom` with `radium`. `Wrapper` is a component for using server side rendering with `radium`. Both of them do not have any example here.'
];
