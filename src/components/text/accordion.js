...
export default [
  ...
  '- `contentStyles`: Use to modify style when the component is clicked. It is a function and the parameter is a boolean to show if the component is clicked. Then, you need to return a object to modify style.',
  '',
  '#### Example',
  '```js',
  '\'use strict\';',
